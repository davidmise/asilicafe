<template>
  <div class="container-fluid page-header mb-5 position-relative overlay-bottom" :style="headerStyle">
...
const props = defineProps({
  ...
  backgroundImage: {
    type: String,
    default: 'carousel-1.jpg'
  }
})

const headerStyle = computed(() => ({
  background: `linear-gradient(rgba(51, 33, 29, .8), rgba(51, 33, 29, .8)), url('/img/${props.backgroundImage}')`,
