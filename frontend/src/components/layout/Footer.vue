...
const newsletterDescription = computed(() => companyStore.getCompanyInfo('newsletter_description') || 'Stay updated with our latest traditional dishes, cultural events, and special promotions at both Asili Cafe branches in Zanzibar')
const socialDescription = computed(() => companyStore.getCompanyInfo('social_description') || 'Follow us for daily updates, authentic recipes, and community events at our Mtweni and Kinazi mmoja locations')
...
<style scoped>
.footer {
  background: linear-gradient(rgba(51, 33, 29, .8), rgba(51, 33, 29, .8)), url('/img/bg.jpg');  background-position: center center;
